...
Let's start slowly before diving in the deep end of category theory with a little undergrad math. If you ever took a math course or two, you inevitably defined sets with certain properties. For example, the numbers in $$\mathbf{N}$$ that are enclosed within a sphere of radius $r$

$$\begin{equation}
A = \{ x \in \mathbf R \| x=0\sum_i x_i\}
\end{equation}
$$
