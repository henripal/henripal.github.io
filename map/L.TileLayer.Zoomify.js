 ...
 * Modified from B. Sandvik's code http://blog.mastermaps.com/2013/06/showing-zoomify-images-with-leaflet.html
 */
...
L.TileLayer.Zoomify = L.TileLayer.extend({
	...
	//	return this._url + 'TileGroup' + this._getTileGroup(tilePoint) + '/' + this._map.getZoom() + '-' + tilePoint.x + '-' + tilePoint.y + '.png';
		return './TileGroup0/' + this._map.getZoom() + '-' + tilePoint.x + '-' + tilePoint.y + '.png';
	},
